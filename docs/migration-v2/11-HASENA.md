...
## 5. DoD
- CHANGE: src/app/(authenticated)/hasena/, src/app/api/hasena/
- EVIDENCE: e2e + row count
- REPRODUCE: `npx playwright test tests/e2e/hasena/`
- ASSERTION: row count 일치, completion toggle 멱등
