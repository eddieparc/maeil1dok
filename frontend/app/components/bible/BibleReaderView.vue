  ...
  <div class="bible-reader-view">
    ...
    <FloatingBottomBar>
      <template #above>
        ...
        <div
          v-if="selectionMenuState.mode === 'action'"
          ...
          @click.stop
        >
          <button class="selection-action-button" @click="handleSelectionHighlightOrRemove">
            <PenIcon :size="16" aria-hidden="true" />
            <span>{{ selectionMenuState.isHighlighted ? '제거' : '하이라이트' }}</span>
          </button>
          <button class="selection-action-button" @click="handleSelectionCopy">
            <CopyIcon :size="16" aria-hidden="true" />
            <span>복사</span>
          </button>
          <button class="selection-action-button" @click="handleSelectionShare">
            <ShareIcon :size="16" aria-hidden="true" />
            <span>공유</span>
          </button>
          <button class="selection-action-button close" aria-label="선택 메뉴 닫기" @click="handleSelectionClose">
            <XMarkIcon :size="16" aria-hidden="true" />
          </button>
        </div>

        <div
          v-else-if="selectionMenuState.mode === 'copy'"
          ...
          @click.stop
        >
          <span class="selection-copy-label">{{ selectionMenuState.isSingleVerse ? '복사' : '구간 복사' }}</span>
          <div class="selection-copy-buttons">
            <template v-if="selectionMenuState.isSingleVerse">
              <button class="selection-copy-button" @click="handleSelectionCopyWithFormat('includeLocation')">
                위치 포함
              </button>
              <span class="selection-action-divider">|</span>
              <button class="selection-copy-button" @click="handleSelectionCopyWithFormat('numOnly')">
                절 번호만
              </button>
              <span class="selection-action-divider">|</span>
              <button class="selection-copy-button" @click="handleSelectionCopyWithFormat('textOnly')">
                내용만
              </button>
            </template>
            <template v-else>
              <button class="selection-copy-button" @click="handleSelectionCopyWithFormat('includeLocationRange')">
                위치 포함
              </button>
              <span class="selection-action-divider">|</span>
              <button class="selection-copy-button" @click="handleSelectionCopyWithFormat('excludeLocationRange')">
                절 번호만
              </button>
            </template>
            <button class="selection-copy-button close" aria-label="복사 메뉴 닫기" @click="handleSelectionCopyClose">
...
import { BookOpenIcon, CalendarCheckIcon, CopyIcon, HeadphonesIcon, PenIcon, ShareIcon } from '@lucide/vue';
...
const handleSelectionCopyWithFormat = (format: string) => {
