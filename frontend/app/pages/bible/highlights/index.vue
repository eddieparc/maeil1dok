<template>
  <BibleSubpageLayout title="내 기록" class="records-page" :loading="auth.isLoading.value || isLoading" loading-text="하이라이트를 불러오는 중..." :empty="isEmpty" :empty-text="emptyText" :empty-hint="emptyHint" :empty-guide="emptyGuide">
    <template #actions>
