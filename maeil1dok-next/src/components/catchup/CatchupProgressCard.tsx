...
export function CatchupProgressCard({
  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
      ...
      <div className="mb-4 flex items-center gap-2 rounded-lg bg-gray-50 px-4 py-3 text-sm">
      ...
      <div className="flex gap-3">
        <button className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-gray-50 px-3 py-3 font-semibold text-gray-900 transition-colors hover:bg-gray-100">
          <span>⚙️</span>
          계획수정
        </button>
        <button className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-3 py-3 font-semibold text-white transition-colors hover:bg-blue-700">
          <span>✅</span>
          따라잡기완료
        </button>
      </div>
