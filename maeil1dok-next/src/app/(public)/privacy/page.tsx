    ...
    <div className="min-h-screen bg-[var(--color-bg-primary)]">
      ...
      <div className="max-w-[768px] mx-auto px-4 py-6">
        <div className="bg-[var(--color-bg-card)] rounded-[20px] shadow-[var(--shadow-md)] border border-[var(--color-border-light)] p-8">
          ...
          <p className="text-sm text-[var(--color-text-secondary)] mb-8">개인정보 처리방침</p>
          ...
          <div className="space-y-6 text-sm leading-relaxed">
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">1. 개인정보의 처리 목적</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">2. 수집하는 개인정보 항목</h2>
              <ul className="list-disc list-inside space-y-2 text-[var(--color-text-secondary)] pl-2">
                <li><strong className="text-[var(--color-text-primary)]">필수항목:</strong> 이메일 주소, 이름, 소셜 로그인 식별자</li>
                <li><strong className="text-[var(--color-text-primary)]">선택항목:</strong> 프로필 이미지, 닉네임</li>
                <li><strong className="text-[var(--color-text-primary)]">자동수집항목:</strong> IP 주소, 쿠키, 서비스 이용 기록, 접속 로그, 기기 정보</li>
              </ul>
            </section>

            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">3. 개인정보의 보유 및 이용기간</h2>
              <p className="text-[var(--color-text-secondary)] mb-2">
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">4. 개인정보의 제3자 제공</h2>
              <p className="text-[var(--color-text-secondary)] mb-2">
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">5. 개인정보의 파기</h2>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">6. 정보주체의 권리·의무 및 행사방법</h2>
              <p className="text-[var(--color-text-secondary)] mb-2">이용자는 개인정보주체로서 다음과 같은 권리를 행사할 수 있습니다.</p>
              <ul className="list-disc list-inside space-y-2 text-[var(--color-text-secondary)] pl-2">
                <li>개인정보 열람 요구</li>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">7. 개인정보의 안전성 확보 조치</h2>
              <p className="text-[var(--color-text-secondary)] mb-2">회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
              <ul className="list-disc list-inside space-y-2 text-[var(--color-text-secondary)] pl-2">
                <li>개인정보의 암호화</li>
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">8. 쿠키의 사용</h2>
              <p className="text-[var(--color-text-secondary)]">
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">9. 개인정보 보호책임자</h2>
              <ul className="list-disc list-inside space-y-2 text-[var(--color-text-secondary)] pl-2">
                <li><strong className="text-[var(--color-text-primary)]">성명:</strong> 박지건</li>
                <li><strong className="text-[var(--color-text-primary)]">연락처:</strong> support@maeil1dok.app</li>
              </ul>
            </section>

            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">10. 권익침해 구제방법</h2>
              <p className="text-[var(--color-text-secondary)] mb-2">개인정보침해에 대한 신고나 상담이 필요하신 경우 아래 기관에 문의하시기 바랍니다.</p>
              <ul className="list-disc list-inside space-y-2 text-[var(--color-text-secondary)] pl-2">
            ...
            <section className="space-y-3">
              <h2 className="text-base font-semibold text-[var(--color-text-primary)]">11. 개인정보 처리방침 변경</h2>
              <p className="text-[var(--color-text-secondary)] mb-2">
              ...
              <p className="text-[var(--color-text-secondary)] pt-4 border-t border-dashed border-[var(--color-border-default)]">
                <strong className="text-[var(--color-text-primary)]">시행일:</strong> 2025년 1월 1일
              </p>
            </section>
          </div>
        </div>
