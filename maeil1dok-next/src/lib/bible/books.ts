export const BIBLE_BOOKS: Record<string, { ko: string; chapters: number; chosung: string }> = {
  ...
  '1sa': { ko: '사무엘상', chapters: 31, chosung: '삼' },
  '2sa': { ko: '사무엘하', chapters: 24, chosung: '삼' },
  '1ki': { ko: '열왕기상', chapters: 22, chosung: '왕' },
  '2ki': { ko: '열왕기하', chapters: 25, chosung: '왕' },
  '1ch': { ko: '역대상', chapters: 29, chosung: '대' },
  '2ch': { ko: '역대하', chapters: 36, chosung: '대' },
  ...
  nam: { ko: '나훔', chapters: 3, chosung: '나' },
  ...
  '1co': { ko: '고린도전서', chapters: 16, chosung: '고' },
  '2co': { ko: '고린도후서', chapters: 13, chosung: '고' },
  ...
  '1th': { ko: '데살로니가전서', chapters: 5, chosung: '데' },
  '2th': { ko: '데살로니가후서', chapters: 3, chosung: '데' },
  '1ti': { ko: '디모데전서', chapters: 6, chosung: '디' },
  '2ti': { ko: '디모데후서', chapters: 4, chosung: '디' },
  tit: { ko: '디도서', chapters: 3, chosung: '디' },
  phm: { ko: '빌레몬서', chapters: 1, chosung: '빌' },
  heb: { ko: '히브리서', chapters: 13, chosung: '히' },
  jas: { ko: '야고보서', chapters: 5, chosung: '야' },
  '1pe': { ko: '베드로전서', chapters: 5, chosung: '베' },
  '2pe': { ko: '베드로후서', chapters: 3, chosung: '베' },
  '1jn': { ko: '요한1서', chapters: 5, chosung: '요' },
  '2jn': { ko: '요한2서', chapters: 1, chosung: '요' },
  '3jn': { ko: '요한3서', chapters: 1, chosung: '요' },
